...
import {auth} from '../base'//gives access to the auth object, which initializes authentication (who are you?)
...
//This component will provide the AuthContext info to the children components nested inside of it. See App.jsx where we call to an instance of this component and nest all other components inside of it.
